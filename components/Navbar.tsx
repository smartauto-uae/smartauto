    ...
    <>
      <header
        ...
        style={{
          ...
          zIndex: 200,                       // ← raised above mobile overlay
          transition: 'background 300ms ease, border-color 300ms ease',
          background: scrolled || mobileOpen  // ← solid when menu is open too
            ? 'rgba(5,5,5,0.98)'
            : 'transparent',
      ...
      >
        ...
        >
          ...
          >
            <Image
              src="/logo.png"              // ← single consistent path
      ...
      {/* Slide-in drawer — comes down from under the header */}
      <div
        role="dialog"
        aria-modal="true"
        ...
        style={{
          position: 'fixed',
          top: 68,                           // ← starts just below header
          left: 0, right: 0,
          zIndex: 190,                       // ← below header (200), above backdrop (150)
